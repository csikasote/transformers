...
<<<<<<< HEAD:examples/pytorch/speech-recognition/wavlm_adapters/utils.py
        array, sampling_rate = torchaudio.load(data['wav'])
=======
        array, sampling_rate = torchaudio.load(data['wav']) #Audio column name
>>>>>>> 9f1ee326e7036e07032297f08d99c7c8884ddd49:examples/pytorch/speech-recognition/peft_wavlm/utils.py
